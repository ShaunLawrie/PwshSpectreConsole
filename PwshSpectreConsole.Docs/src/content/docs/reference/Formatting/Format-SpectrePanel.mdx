...
import formatspectrepanelExample3 from '../../../../assets/examples/formatspectrepanelExample3.cast?url'
import formatspectrepanelExample4 from '../../../../assets/examples/formatspectrepanelExample4.cast?url'
...
```
<Asciinema
    src={formatspectrepanelExample3}
    settings={{
        loop: false,
        terminalLineHeight: 1.1,
        theme: "spectre",
...
```
<Asciinema
    src={formatspectrepanelExample4}
    settings={{
        loop: false,
        terminalLineHeight: 1.1,
        theme: "spectre",

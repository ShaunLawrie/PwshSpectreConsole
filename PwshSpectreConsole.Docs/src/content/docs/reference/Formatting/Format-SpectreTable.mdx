...
import formatspectretableExample1 from '../../../../assets/examples/formatspectretableExample1.cast?url'
import formatspectretableExample2 from '../../../../assets/examples/formatspectretableExample2.cast?url'
import formatspectretableExample3 from '../../../../assets/examples/formatspectretableExample3.cast?url'
...
```
<Asciinema
    src={formatspectretableExample1}
    settings={{
        loop: false,
...
```
<Asciinema
    src={formatspectretableExample2}
    settings={{
        loop: false,
        terminalLineHeight: 1.1,
        theme: "spectre",
...
```
<Asciinema
    src={formatspectretableExample3}
    settings={{
        loop: false,
        terminalLineHeight: 1.1,
        theme: "spectre",
...
### Syntax
```powershell
Format-SpectreTable -Data <Object> [-Wrap] [-Border <String>] [-Color <Color>] [-HeaderColor <Color>] [-TextColor <Color>] [-Width <Int32>] [-HideHeaders] [-Title <String>] [-AllowMarkup] [-PassThru] [<CommonParameters>]
```
```powershell
Format-SpectreTable -Data <Object> [[-Property] <Object[]>] [-Wrap] [-Border <String>] [-Color <Color>] [-HeaderColor <Color>] [-TextColor <Color>] [-Width <Int32>] [-HideHeaders] [-Title <String>] [-AllowMarkup] [-PassThru] [<CommonParameters>]
```
```powershell
Format-SpectreTable -Data <Object> [-Wrap] [-View <String>] [-Border <String>] [-Color <Color>] [-HeaderColor <Color>] [-TextColor <Color>] [-Width <Int32>] [-HideHeaders] [-Title <String>] [-AllowMarkup] [-PassThru] [<CommonParameters>]
```

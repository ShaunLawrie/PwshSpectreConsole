...
|----------|--------|--------|------------------------------|----------------|
|`[String]`|true    |1       |true (ByValue, ByPropertyName)|Uri<br/>FullName|
...
|Type     |Required|Position|PipelineInput        |Aliases|
|---------|--------|--------|---------------------|-------|
|`[Int32]`|false   |2       |true (ByPropertyName)|Width  |
...
### Syntax
```powershell
Get-SpectreImage [-ImagePath] <String> [[-MaxWidth] <Int32>] [[-Format] {Auto | Sixel | Blocks | Braille | Canvas}] [-Force] [-Animation] [<CommonParameters>]
```

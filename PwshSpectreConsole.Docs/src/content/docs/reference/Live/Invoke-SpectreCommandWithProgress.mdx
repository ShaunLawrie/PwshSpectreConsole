...
import invokespectrecommandwithprogressExample5 from '../../../../assets/examples/invokespectrecommandwithprogressExample5.cast?url'
...
```
<Asciinema
    src={invokespectrecommandwithprogressExample5}
    settings={{
        loop: false,
        terminalLineHeight: 1.1,
        theme: "spectre",

...
### Syntax
```powershell
Read-SpectreSelectionGrouped [[-Message] <String>] [-Choices] <Hashtable> [[-ChoiceLabelProperty] <Object>] [[-Color] <Color>] [[-PageSize] <Int32>] [-EnableSearch] [[-TimeoutSeconds] <Int32>] [[-SearchHighlightColor] <Color>] [<CommonParameters>]
```

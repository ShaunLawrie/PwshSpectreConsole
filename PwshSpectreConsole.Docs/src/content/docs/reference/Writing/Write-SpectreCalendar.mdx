...
import writespectrecalendarExample1 from '../../../../assets/examples/writespectrecalendarExample1.cast?url'
import writespectrecalendarExample2 from '../../../../assets/examples/writespectrecalendarExample2.cast?url'
...
```
<Asciinema
    src={writespectrecalendarExample1}
    settings={{
        loop: false,
...
```
<Asciinema
    src={writespectrecalendarExample2}
    settings={{
        loop: false,
        terminalLineHeight: 1.1,
        theme: "spectre",

...
function Install-SpectreConsole {
    ...
    Invoke-WebRequest "https://www.nuget.org/api/v2/package/Spectre.Console.Testing/$Version" -OutFile $downloadLocation
    ...
    New-Item -Path $libPath -ItemType 'Directory' -Force | Out-Null
    $downloadLocation = Join-Path $libPath 'download.zip'
    Invoke-WebRequest "https://www.nuget.org/api/v2/package/Spectre.Console/$Version" -OutFile $downloadLocation
    Expand-Archive $downloadLocation $libPath -Force
    Remove-Item $downloadLocation
    ...
    New-Item -Path $libPath -ItemType 'Directory' -Force | Out-Null
    $downloadLocation = Join-Path $libPath 'download.zip'
    Invoke-WebRequest "https://www.nuget.org/api/v2/package/Spectre.Console.ImageSharp/$Version" -OutFile $downloadLocation
    Expand-Archive $downloadLocation $libPath -Force
    Remove-Item $downloadLocation
    ...
    New-Item -Path $libPath -ItemType 'Directory' -Force | Out-Null
    $downloadLocation = Join-Path $libPath 'download.zip'
    Invoke-WebRequest "https://www.nuget.org/api/v2/package/SixLabors.ImageSharp/$imageSharpVersion" -OutFile $downloadLocation
    Expand-Archive $downloadLocation $libPath -Force
    Remove-Item $downloadLocation
    ...
    New-Item -Path $libPath -ItemType 'Directory' -Force | Out-Null
    $downloadLocation = Join-Path $libPath 'download.zip'
    Invoke-WebRequest "https://www.nuget.org/api/v2/package/Spectre.Console.Json/$Version" -OutFile $downloadLocation
    Expand-Archive $downloadLocation $libPath -Force
    Remove-Item $downloadLocation

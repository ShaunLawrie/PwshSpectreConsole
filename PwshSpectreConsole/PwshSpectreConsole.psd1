...
RequiredAssemblies = @(
            ...
            './lib/Spectre.Console.Json.dll'
            './lib/Spectre.Console.Testing.dll'
            './lib/SixLabors.ImageSharp.dll'
            './lib/PwshSpectreConsole.dll'
        )
...
FunctionsToExport = 'Add-SpectreJob', 'Format-SpectreBarChart',
               ...
               'Read-SpectreSelectionGrouped', 'Open-PwshSpectreConsoleHelp',
               'Get-SpectreLayoutSizes', 'Get-SpectreColors', 'Format-SpectreMarkdown'
